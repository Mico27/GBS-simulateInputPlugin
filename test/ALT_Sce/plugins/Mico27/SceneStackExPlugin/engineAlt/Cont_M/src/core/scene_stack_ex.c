...
typedef struct continuous_scene_stack_item_t {
    //continuous scene
    UBYTE continuous_scene_enabled;
    continuous_scene_t continuous_scenes[8];
} continuous_scene_stack_item_t;
...
typedef struct scene_stack_item_ex_t {
    ...
    continuous_scene_stack_item_t continuous_scene_stack_item;
    uint16_t rand_seed;
...
static void push_continuous_scene_stack_item(void){
    continuous_scene_stack_item_t* continuous_scene_stack_item = &scene_stack_ex_ptr->continuous_scene_stack_item;
    continuous_scene_stack_item->continuous_scene_enabled = continuous_scene_enabled;
    memcpy(continuous_scene_stack_item->continuous_scenes, continuous_scenes, sizeof(continuous_scenes));
}
...
void push_scene_stack_ex(void) BANKED {
    if (scene_stack_ex_count < MAX_SCENE_STACK_EX_COUNT){
        ...
        push_continuous_scene_stack_item();
...
static void pop_continuous_scene_stack_item(void){
    continuous_scene_stack_item_t* continuous_scene_stack_item = &scene_stack_ex_ptr->continuous_scene_stack_item;
    continuous_scene_enabled = continuous_scene_stack_item->continuous_scene_enabled;
    memcpy(continuous_scenes, continuous_scene_stack_item->continuous_scenes, sizeof(continuous_scenes));
}
...
UBYTE pop_scene_stack_ex(void) BANKED {
    if (scene_stack_ex_count > 0){
        ...
        pop_continuous_scene_stack_item();
